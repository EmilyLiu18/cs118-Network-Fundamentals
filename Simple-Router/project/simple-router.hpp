...
public:
  ...
  void prepare_send_arp_response(const Interface* iface, ethernet_hdr* ehdr, arp_hdr* ahdr);
  void sendEnqPack(arp_hdr* ahdr, const Interface* iface);
  void forwardPacket(const Buffer& packet, ip_hdr* ipH);
  void
